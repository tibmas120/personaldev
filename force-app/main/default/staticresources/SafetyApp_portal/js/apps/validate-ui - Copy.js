$().ready(function () {
    ...
    $('.application_form').validate({
        ...
        messages: {
            ...
            addAttachment1: {
                required: 'Error: This field is required.',
                extension: 'Error: Please upload an attachment in PDF, JPG, or PDF format.',
    ...
    $(".addAttachment001").change(function () {
        ...
        if(null !== f){
            ...
            if (($.inArray($(this).val().split('.').pop().toLowerCase(), fileExtension) == -1)) {
                ...
                $("#addAttachment1-error").html("Error: Please upload an attachment in PDF, JPG, or PDF format.");
    ...
    $(".addAttachment002").change(function () {
        ...
        if(null !== f){
            ...
            if (($.inArray($(this).val().split('.').pop().toLowerCase(), fileExtension) == -1)) {
                ...
                $("#addAttachment2-error").html("Error: Please upload an attachment in PDF, JPG, or PDF format.");
    ...
    $(".addAttachment003").change(function () {
        ...
        if(null !== f){
            ...
            if (($.inArray($(this).val().split('.').pop().toLowerCase(), fileExtension) == -1)) {
                ...
                $("#addAttachment3-error").html("Error: Please upload an attachment in PDF, JPG, or PDF format.");
    ...
    $(".addAttachment004").change(function () {
        ...
        if(null !== f){
            ...
            if (($.inArray($(this).val().split('.').pop().toLowerCase(), fileExtension) == -1)) {
                ...
                $("#addAttachment4-error").html("Error: Please upload an attachment in PDF, JPG, or PDF format.");
